                            ...
                            <div class="inputs clearfix">
                                ...
                                <div class="col-md-6 input">
                                    <div class="material-input">
                                        <input onkeyup="this.value=removeSpaces(this.value);" type="text" id="user_name"
                                               name="user_name">
                                ...
                                <div class="col-md-6 input">
                                    <div class="material-input">
                                        <input onkeyup="this.value=removeSpaces(this.value);" type="text" id="know"
                                               name="know">
                                        <span class="highlight"></span>
                                        <span class="bar"></span>
                                    ...
                                    <div class="item col-md-4 col-sm-6">
                                        <div class="i-content">
                                            ...
                                            <div class="details-area">
                                                <h3 class="d-title"><a href="{{$value->link}}"
                                                                       target="_blank">{{$value->name}}</a></h3>
                                                <div class="d-value"><a href="{{$value->link}}"
                                                                        target="_blank">{{$value->val}}</a></div>
