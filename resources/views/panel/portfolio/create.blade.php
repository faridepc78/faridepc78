...
@section('css')
    <link rel="stylesheet" href="{{asset('panel/plugins/persianDatepicker/css/persianDatepicker-default.css')}}">
@endsection
...
@section('js')
    <script src="{{asset('panel/plugins/persianDatepicker/js/persianDatepicker.min.js')}}"></script>
