...
@section('css')
    <link rel="stylesheet" href="{{asset('panel/plugins/bootstrap-select/css/bootstrap-select.min.css')}}">
@endsection
...
@section('js')
    <script type="text/javascript"
            src="{{asset('panel/plugins/bootstrap-select/js/bootstrap-select.min.js')}}"></script>
@endsection
