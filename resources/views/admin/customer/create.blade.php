            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <form id="create_customer_form" action="{{route('customer.store')}}" method="post">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea onkeyup="this.value=removeSpaces(this.value)" style="resize: vertical" rows="5" type="text" class="form-control @error('text') is-invalid @enderror"
                                           id="text" name="text"
                                           placeholder="لطفا نظر مشتری را وارد کنید" autocomplete="text" autofocus>{{ old('text') }}</textarea>
