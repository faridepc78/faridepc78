...
class PostCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('panel.post_category.index', compact('postCategory'));
    }

    public function create()
    {
        return view('panel.post_category.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('panel.post_category.edit', compact('postCategory'));
    }
