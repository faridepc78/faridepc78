...
use App\Http\Requests\Panel\Expertise\CreateExpertiseRequest;
use App\Http\Requests\Panel\Expertise\UpdateExpertiseRequest;
...
class ExpertiseController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('panel.expertise.index', compact('expertises'));
    }

    public function create()
    {
        return view('panel.expertise.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('panel.expertise.edit', compact('expertise'));
    }
