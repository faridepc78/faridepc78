...
use App\Http\Requests\Panel\PortfolioExpertise\CreatePortfolioExpertiseRequest;
...
class PortfolioExpertiseController extends Controller
{
    ...
    public function index($id)
    {
        ...
        return view('panel.portfolio.expertise.management', compact('portfolio', 'expertise', 'portfolioExpertise'));
    }
