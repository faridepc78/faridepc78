...
use App\Http\Requests\Panel\ContactInfo\CreateContactInfoRequest;
use App\Http\Requests\Panel\ContactInfo\UpdateContactInfoRequest;
...
class ContactInfoController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('panel.contact_info.index',compact('contactInfo'));
    }

    public function create()
    {
        return view('panel.contact_info.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('panel.contact_info.edit', compact('contactInfo'));
    }
