...
use App\Http\Requests\Panel\Resume\CreateResumeRequest;
use App\Http\Requests\Panel\Resume\UpdateResumeRequest;
...
class ResumeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('panel.resume.index',compact('resume'));
    }

    public function create()
    {
        return view('panel.resume.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('panel.resume.edit', compact('resume'));
    }
