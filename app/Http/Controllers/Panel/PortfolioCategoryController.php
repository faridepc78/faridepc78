...
use App\Http\Requests\Panel\PortfolioCategory\CreatePortfolioCategoryRequest;
use App\Http\Requests\Panel\PortfolioCategory\UpdatePortfolioCategoryRequest;
...
class PortfolioCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('panel.portfolio_category.index', compact('portfolio_category'));
    }

    public function create()
    {
        return view('panel.portfolio_category.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('panel.portfolio_category.edit', compact('portfolio_category'));
    }
