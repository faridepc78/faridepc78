...
class PostCommentRepository
{
    ...
    public function getAllPostCommentByPostId($id)
    {
        $data = [
            'parent_id' => null,
            'post_id' => $id
    ...
    public function pendingPostComment($id)
    {
        $data = [
            'parent_id' => null,
    ...
    public function activePostComment($id)
    {
        $data = [
            'parent_id' => null,
            'status' => PostComment::ACTIVE_STATUS,
    ...
    public function inactivePostComment($id)
    {
        $data = [
            'parent_id' => null,
